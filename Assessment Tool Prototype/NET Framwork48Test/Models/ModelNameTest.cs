...
namespace NET_Framwork48.Models.Tests
{
    ...
    public class ModelNameTest
    {
        ...
        public void CreateModelDictionaryTest()
        {
            ...
            Assert.AreEqual(ModelName.LEVEL4_NUM, level4_metric_detail.Count);
            string str_get;
            for (int i = 0; i < ModelName.LEVEL4_NUM; i++)
        ...
        public void SetNodeNameTest()
        {
            ...
            ModelNode[] node1 = new ModelNode[ModelName.LEVEL1_NUM];
            ModelNode[] node2 = new ModelNode[ModelName.LEVEL2_NUM];
            ModelNode[] node3 = new ModelNode[ModelName.LEVEL3_NUM];
            ModelNode[] node4 = new ModelNode[ModelName.LEVEL4_NUM];
            //第一层
            for (int i = 0; i < ModelName.LEVEL1_NUM; i++)
            {
            ...
            //第二层
            for (int i = 0; i < ModelName.LEVEL2_NUM; i++)
            {
            ...
            //第三层
            for (int i = 0; i < ModelName.LEVEL3_NUM; i++)
            {
